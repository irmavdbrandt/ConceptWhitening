...
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 30 --batch-size 12 --lr 0.01 --whitened_layers 3 --concepts largest_asymmetric_bulge,base_pairs_wobbles_in_stem --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER modhsa_original/
# evaluation
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 1 --batch-size 1 --lr 0.1 --whitened_layers 1 --concepts largest_asymmetric_bulge,base_pairs_wobbles_in_stem --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER --resume ./checkpoints/largest_asymmetric_bulge_base_pairs_wobbles_in_stem/DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER_1_foldn2_checkpoint.pth.tar modhsa_original/original_dataset/ --evaluate --foldn_bestmodel 2
