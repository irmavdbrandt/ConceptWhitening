...
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 30 --batch-size 12 --lr 0.01 --whitened_layers 3 --concepts largest_asymmetric_bulge,base_pairs_wobbles_in_stem,AU_pair_begin_maturemiRNA,presence_terminal_loop --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER modhsa_original/
# evaluation
...
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 1 --batch-size 1 --lr 0.001 --whitened_layers 3 --concepts largest_asymmetric_bulge,base_pairs_wobbles_in_stem,AU_pair_begin_maturemiRNA,presence_terminal_loop --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER --resume ./checkpoints/largest_asymmetric_bulge_base_pairs_wobbles_in_stem_AU_pair_begin_maturemiRNA_presence_terminal_loop/DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER_3_foldn1_model_best.pth.tar modhsa_original/original_dataset/ --evaluate --foldn_bestmodel 1


#%%
# finetuning model
python train_premirna.py --workers 0 --arch deepmir_resnet_bn_v3 --epochs 100 --batch-size 128 --lr 0.00001 --whitened_layers 1 --concepts presence_terminal_loop --prefix DEEPMIR_RESNET_PREMIRNA_v3_BN  modhsa_original/original_dataset/

python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v3 --epochs 30 --batch-size 12 --lr 0.01 --whitened_layers 3 --concepts largest_asymmetric_bulge,AU_pair_begin_maturemiRNA --prefix DEEPMIR_RESNET_PREMIRNA_v3_CPT_WHITEN_TRANSFER modhsa_original/
