...
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 1 --batch-size 32 --lr 0.1 --whitened_layers 2 --concepts presence_terminal_loop,asymmetric,base_pairs_wobbles_in_stem,width_gap_start --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER modhsa_original/
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 3 --batch-size 64 --lr 0.05 --whitened_layers 3 --concepts presence_terminal_loop,asymmetric,base_pairs_wobbles_in_stem,width_gap_start --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER modhsa_original/
# all layers together still not working nicely....
...
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 1 --batch-size 1 --lr 0.01 --whitened_layers 2 --concepts presence_terminal_loop,asymmetric,base_pairs_wobbles_in_stem,width_gap_start --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER --resume ./checkpoints/presence_terminal_loop_asymmetric_base_pairs_wobbles_in_stem_width_gap_start/DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER_2_checkpoint.pth.tar modhsa_original/ --evaluate
python train_premirna.py --workers 0 --arch deepmir_resnet_cw_v2 --epochs 1 --batch-size 1 --lr 0.1 --whitened_layers 3 --concepts presence_terminal_loop,asymmetric,base_pairs_wobbles_in_stem,width_gap_start --prefix DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER --resume ./checkpoints/presence_terminal_loop_asymmetric_base_pairs_wobbles_in_stem_width_gap_start/DEEPMIR_RESNET_PREMIRNA_v2_CPT_WHITEN_TRANSFER_3_checkpoint.pth.tar modhsa_original/ --evaluate
