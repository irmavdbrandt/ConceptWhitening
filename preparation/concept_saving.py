...
def create_annotated_df():
    for dirname, _, filenames in os.walk('modhsa_original/original_dataset/'):
        for filename in filenames:
            ...
            entry['largest_asymmetric_bulge'] = largest_bulge
...
# largest_bulge_stats = calculate_summary_stats(data_tables, 'class_label', 'largest_asymmetric_bulge')
...
#
#
# binary_concepts_of_interest = ['presence_terminal_loop', 'asymmetric', 'UGU', 'AU_pair_begin_maturemiRNA',
#                                'base_wobble_stem_1nt_4nt']
# non_binary_concepts_of_interest = [('width_gap_start', 6), ('base_pairs_wobbles_in_stem', 0.9),
#                                    ('largest_asymmetric_bulge', 6.5)]  # threshold base pairs used to be 0.75
#
