...
# Test cases to check whether the definitions are correct
# positive class tests
# image = './datasets/modhsa_original/original_dataset/test/1/hsa-mir-30a.png'
# image = './datasets/modhsa_original/original_dataset/test/1/hsa-mir-1-1.png'
# image = './datasets/modhsa_original/original_dataset/test/1/hsa-mir-1-2.png'
# image = './datasets/modhsa_original/original_dataset/test/1/hsa-mir-30c-1.png'
# image = './datasets/modhsa_original/original_dataset/test/1/hsa-mir-9-1.png'
# image = './datasets/modhsa_original/original_dataset/test/1/hsa-mir-15b.png'
# image = './datasets/modhsa_original/original_dataset/train/1/hsa-mir-6126.png'
# image = './datasets/modhsa_original/original_dataset/test/1/hsa-mir-4692.png'

# negative class tests
# image = './datasets/modhsa_original/original_dataset/test/0/162.png'
image = './datasets/modhsa_original/original_dataset/test/0/19.png'
# image = './datasets/modhsa_original/original_dataset/test/0/hsa1_4934.png'
# image = './datasets/modhsa_original/original_dataset/test/0/1409.png'
# image = './datasets/modhsa_original/original_dataset/test/0/320.png'
# image = './datasets/modhsa_original/original_dataset/test/0/556.png'
# image = './datasets/modhsa_original/original_dataset/test/0/709.png'
#
...
sequence_pairs, stem_begin = pairs_stem(image_array)
terminal_loop_present, start_pixel, highest_row, highest_pixel, length, width, width_gap_start \
    = loop_concepts(image_array, sequence_pairs)
UGU_motif_present = ugu_motif(image_array, terminal_loop_present, highest_pixel, start_pixel)
AU_pair_present = AU_pairs_begin_maturemiRNA(sequence_pairs)
symmetric_bulges_list, asymmetric_bulges_list, symmetric_bulge_info_list, asymmetric_bulge_info_list = \
    bulges(image_array, sequence_pairs, start_pixel, stem_begin)
palindrome_score, upper_image_half_counts, lower_image_half_counts, length_premiRNA = palindrome(image_array)
largest_asymmetric_bulge, largest_asymmetric_bulge_location = large_asymmetric_bulge(image_array)
